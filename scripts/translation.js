...
let translationArray = [
   ...
   [
      ...
      "Concevez Un Réseau Adoré Par Vos Fans",
   ],
   [
   ...
   [
      document.getElementsByClassName("boutonRose")[0],
      "Get Started For Free",
      "Démarrez gratuitement",
   ],
   [
      document.querySelectorAll("main section h3")[0],
      "Grow Together",
      "Évoluez ensemble",
   ],
   [
      document.querySelectorAll("main section p")[0],
   ...
   [
      document.querySelectorAll("main section h3")[1],
      "Flowing Conversations",
      "Des conversations fluides",
   ],
   [
      document.querySelectorAll("main section p")[1],
   ...
   [
      document.querySelectorAll("main section h3")[2],
      "Your Users",
      "Vos utilisateurs",
   ],
   [
      document.querySelectorAll("main section p")[2],
      "It takes no time at all to integrate Huddle with your app's authentification solution. This means, once signed in to your app, your users can start chatting immediately.",
   ...
   [
      document.querySelector("#boiteGetReady h2"),
      "Ready To Build Your Community?",
      "Prêt à créer une communauté?",
   ],
   [
      document.getElementsByClassName("boutonRose")[1],
      "Get Started For Free",
      "Démarrez gratuitement",
   ],
...
function switchLanguage() {
   ...
   if (isEnglish == true) {
      ...
      // Otherwise switch back to english
   } else {
      for (let i = 0; i < translationArray.length; i++) {
