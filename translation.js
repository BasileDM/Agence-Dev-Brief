...
let translationArray = [
    ...
    [document.querySelector('header h1'), "Build The Community Your Fans Will Love", "Construisez une communeauté inoubliable" ],
    ...
    "Huddle réinvente votre façon de construire une communeauté. Vous avez une voix, mais votre audience aussi. Connectez avec vos utilisateurs lors d'authentiques discussions."],
    ...
    [document.querySelector('#boiteGetReady h2'), "Ready To Build Your Community?", "Prêt à créer une communeauté?"],
